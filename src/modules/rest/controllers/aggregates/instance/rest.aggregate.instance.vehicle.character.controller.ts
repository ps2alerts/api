...
export default class RestInstanceVehicleCharacterController {
    ...
    async findAll(@Param('instance') instance: string,
        ...
        return this.mongoOperationsService.findMany(InstanceVehicleCharacterAggregateEntity, {instance}, new Pagination({sortBy, order, page, pageSize}));
    }
    ...
    async findCharacter(
        ...
        return this.mongoOperationsService.findMany(InstanceVehicleCharacterAggregateEntity, {instance, character}, new Pagination({sortBy, order, page, pageSize}));
    }
